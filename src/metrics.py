...
def prcauc(y_true: np.ndarray, y_pred: np.ndarray | None, y_proba: np.ndarray) -> float:
    """
    Precision-Recall AUC based on predicted scores.
    """
    return _sk_metrics.average_precision_score(y_true, y_proba)
